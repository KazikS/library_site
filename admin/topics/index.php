...
<div class="container">
    ...
    <div class="posts col-9">
        ...
        <div class="row title-table">
            ...
            <div class="name col-5">Название</div>
            <div class="manage col-4">Управление</div>
        </div>
        <?php foreach ($allTopics as $key => $topic): ?>
        <div class="row post">
            <div class="id col-1"><?= $key + 1; ?></div>
            <div class="name col-5"><?=$topic['name']?></div>
            <div class="red col-2"><a href="edit.php?id=<?=$topic['id'];?>">edit</a> </div>
            <div class="delete col-2"><a href="edit.php?del_id=<?=$topic['id'];?>">delete</a> </div>
        </div>
        <?php endforeach;?>
    </div>
</div>
